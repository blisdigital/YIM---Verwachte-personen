...
De popover-inhoud wordt volledig geleverd door `DatePopover`. Zie [ui-atoms.md → DatePopover](ui-atoms.md#datepopover) voor de volledige specificatie inclusief tokens.
