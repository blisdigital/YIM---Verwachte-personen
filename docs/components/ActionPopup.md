...
> **Geen** scheidingslijn tussen header en body — header vloeit visueel over in content. Tussen body en footer staat wel een `border-top`.
...
| `--n300` | Footer scheidingslijn (border-top), rand |
| `--n900` | Titeltekst |
| `--r-l` | Afronding popup |
...
|---|---|---|
| `AanmeldenModal.vue` | Persoon aanmelden | Bevestiging + persoonskaart |
| `AfmeldenModal.vue` | Persoon afmelden | Bevestiging |
| `AnnulerenModal.vue` | Aanmelding annuleren | Destructieve bevestiging |
| `InformeerContactpersoonModal.vue` | Contactpersoon informeren | Info + mail |
| `CredentialActiverenModal.vue` | Credential activeren | Multi-stap flow |
| `CredentialMailenModal.vue` | Credential mailen | Bevestiging |
| `CredentialOntkoppelenModal.vue` | Credential ontkoppelen | Destructieve bevestiging |
| `ElearningUitnodigingModal.vue` | E-learning uitnodiging | Twee-staps flow |
