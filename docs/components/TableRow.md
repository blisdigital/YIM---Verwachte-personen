...
| --- | --- | --- |
| Rij achtergrond | `--p50` | `#f0f7f8` |
| Rij hover | `--p100` | `#d6e8ec` |
| VIP border | `--vip-border` | `#f59e0b` |
| Cel tekst | `--p800` | `#14626f` |
| Cel border | `--p100` | `#d6e8ec` |
| Sticky achtergrond | `--p50` | `#f0f7f8` |
| Naam tekst | `--p800` | `#14626f` |
| VIP icoon | `--vip-border` | `#f59e0b` |
| Cel dash | `--n400` | `#b8babb` |
| Parkeren geen | `--n500` | `#999a9b` |
| Parkeren badge | `--info` | `#2464bb` |
| Locatie pill bg | `--p100` | `#d6e8ec` |
| Locatie pill tekst | `--p700` | `#1a7a8a` |
| Locatie pill radius | `--r-xl` | `360px` |
| Overflow pill bg | `--n0` | `#ffffff` |
| Overflow pill tekst | `--p500` | `#6daeba` |
